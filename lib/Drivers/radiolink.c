...
void Version_Init(uint16_t protocolIndex) { versionSelectFlg = protocolIndex; }
uint8_t Get_Protocol_Select(void) { return versionSelectFlg; }
...
//      break;
  ...
  while (1) {
    ...
    radioEvent = xEventGroupWaitBits(radioEventHandle, RADIOLINK_BIND, pdTRUE, pdFALSE, 0);
