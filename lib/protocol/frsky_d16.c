...
uint8_t highThrottleFlg = 1;    //�����ű�־λ
static uint16_t TransmitterID;  //ң����ΨһID
...
static uint16_t Channel_DataBuff[16] = {1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500,
...
const uint8_t FRSKYD16_CH_Code[16] = {AILERON, ELEVATOR, THROTTLE, RUDDER, AUX1, AUX2,  AUX3,  AUX4,
...
/*-------------------------------------------------------------------------------
                        get next channel
--------------------------------------------------------------------------------*/
static void FRSKYD16_calc_next_chan(void) { FRSKYD16_Channel_Num = (FRSKYD16_Channel_Num + FRSKYD16_ChannelShip) % 47; }
...
void Calc_FRSKYD16_Channel() {
  ...
  while (idx < 47) {
    ...
    // get frequency point
    if (((next_ch < 27) && (count_1_26 < 16)) || ((next_ch >= 27) && (next_ch < 53) && (count_27_52 < 15)) ||
        ((next_ch >= 53) && (count_53_76 < 16))) {
