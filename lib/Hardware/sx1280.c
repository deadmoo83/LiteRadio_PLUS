...
void SX1280_Init() {
  ...
  SX1280_WriteRegister(
      0x0891, (SX1280_ReadRegister(0x0891) | 0xC0));  // default is low power mode, switch to high sensitivity instead
  SX1280_SetPacketParams(12, SX1280_LORA_PACKET_IMPLICIT, 8, SX1280_LORA_CRC_OFF,
  ...
  SX1280_SetDioIrqParams(SX1280_IRQ_RADIO_ALL, SX1280_IRQ_TX_DONE | SX1280_IRQ_RX_DONE, SX1280_IRQ_RADIO_NONE,
                         SX1280_IRQ_RADIO_NONE);  // set IRQ to both RXdone/TXdone on DIO1
}
...
void SX1280_ConfigLoRaModParams(SX1280_RadioLoRaBandwidths_t bw, SX1280_RadioLoRaSpreadingFactors_t sf,
...
void SX1280_SetPacketParams(uint8_t PreambleLength, SX1280_RadioLoRaPacketLengthsModes_t HeaderType,
                            uint8_t PayloadLength, SX1280_RadioLoRaCrcModes_t crc, SX1280_RadioLoRaIQModes_t InvertIQ) {
  uint8_t buf[7];
...
void SX1280_WriteRegister(uint16_t address, uint8_t value) { SX1280_HalWriteRegister(address, &value, 1); }

void SX1280_Config(SX1280_RadioLoRaBandwidths_t bw, SX1280_RadioLoRaSpreadingFactors_t sf,
                   SX1280_RadioLoRaCodingRates_t cr, uint32_t freq, uint8_t PreambleLength, uint8_t InvertIQ) {
  SX1280.IQinverted = InvertIQ;
  SX1280_SetMode(SX1280_MODE_STDBY_XOSC);
  SX1280_ClearIrqStatus(SX1280_IRQ_RADIO_ALL);
  SX1280_ConfigLoRaModParams(bw, sf, cr);
  SX1280_SetPacketParams(
      PreambleLength, SX1280_LORA_PACKET_IMPLICIT, 8, SX1280_LORA_CRC_OFF,
      (SX1280_RadioLoRaIQModes_t) ((uint8_t) !SX1280.IQinverted
